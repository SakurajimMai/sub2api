...
services:
  sub2api:
    image: sakurajiamai/sub2api:latest
    ports:
      - "8080:8080"
    environment:
...
- [GitHub Repository](https://github.com/SakurajimMai/sub2api)
- [Documentation](https://github.com/SakurajimMai/sub2api#readme)
- [Docker Hub](https://hub.docker.com/r/sakurajiamai/sub2api)
- [GHCR](https://github.com/SakurajimMai/sub2api/pkgs/container/sub2api)
