...
> **Fork note:** this tree defaults to Docker image `sakurajiamai/sub2api` and repo `SakurajimMai/sub2api`.
> Upstream sync + branding protection is documented in [`.fork/README.md`](../.fork/README.md).
...
curl -sSL https://raw.githubusercontent.com/SakurajimMai/sub2api/main/deploy/docker-deploy.sh -o docker-deploy.sh
...
1. Download the latest release from [GitHub Releases](https://github.com/SakurajimMai/sub2api/releases)
