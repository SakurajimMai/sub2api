...
# Sub2API 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/SakurajimMai/sub2api/main/deploy/install.sh | bash
#
...
# Configuration
GITHUB_REPO="SakurajimMai/sub2api"
...
Documentation=https://github.com/SakurajimMai/sub2api
