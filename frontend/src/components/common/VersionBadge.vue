...
const GITHUB_REPO = 'SakurajimMai/sub2api'
// Docker Hub image published by CI (tags carry no "v" prefix, e.g. sakurajiamai/sub2api:0.1.146)
const DOCKER_IMAGE = 'sakurajiamai/sub2api'
